          ...
          {loadingData === 'success' && (
            <>
              ...
              <IonRow className="ion-padding-top">
                ...
                {/* 1 - pending  */}
                {getValues('status') === '1' && userInfo.type === '4' && (
                  <>
                    {/* approved */}
                    <IonCol size="6">
                      <IonButton
                ...
                {getValues('status') === '2' && userInfo.type === '4' && (
                  <IonCol size="12">
                    <IonButton
                      shape="round"
                      expand="full"
                ...
                {getValues('status') === '3' && userInfo.type === '4' && (
                  <IonCol size="12">
                    <IonButton
                      shape="round"
                      expand="full"
                ...
                {/* 4 - Rejected */}
                {getValues('status') === '4' && userInfo.type === '4' && (
                  <IonCol size="12">
                    <IonButton
                      shape="round"
                      expand="full"
                ...
                {/* 5 - Canceled */}
                {getValues('status') === '5' && userInfo.type === '4' && (
                  <IonCol size="12">
                    <IonButton
                      shape="round"
                      expand="full"
                ...
                {/* 6 - Completed */}
                {getValues('status') === '6' && userInfo.type === '4' && (
                  <IonCol size="12">
                    <IonButton
                      shape="round"
                      expand="full"
                ...
                {/* 7 - Arrived => 8 - ready*/}
                {getValues('status') === '7' && userInfo.type === '4' && (
                  <IonCol size="12">
                    <IonButton
                      shape="round"
                      expand="full"
                ...
                {/* 8 - Ready => 6 - completed*/}
                {getValues('status') === '8' && userInfo.type === '4' && (
                  <IonCol size="12">
                    <IonButton
                      shape="round"
                      expand="full"
